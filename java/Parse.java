public class Parse {
    ...
    public static boolean parseBackground(String[] properties, ImageStore imageStore, WorldModel world) {
        ...
        if (properties.length == MINER_NUM_PROPERTIES) {
            ...
            world.tryAddEntity(entity, world);
        }
    ...
    public static boolean parseBlacksmith(String[] properties, ImageStore imageStore, WorldModel world) {
        if (properties.length == SMITH_NUM_PROPERTIES)
        {
            Point pt = new Point(Integer.parseInt(properties[SMITH_COL]),
                    Integer.parseInt(properties[SMITH_ROW]));
            Entity entity = Create.createSmith(properties[SMITH_ID],
