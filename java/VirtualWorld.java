        ...
        extends PApplet
{
   ...
   */
   ...
   public void draw()
   {
      ...
      drawViewport(view.viewport,view);
   }
                                      ...
                                      EventScheduler scheduler, ImageStore imageStore)
   {
      ...
      {
         entity.scheduleActions(scheduler, entity, imageStore, world);
      }
   }
   public void drawViewport(Viewport view, WorldView wView)
   {
      wView.drawBackground(world, view);
      wView.drawEntities(view);
   }
